...
<html lang="en">
  ...
  <body>
    <div id="login"><h2>
	Work order form for <?php echo($_GET['url']); ?></h2>
    <div id="form">
    <div class="top">

	<form action="workOrder.php" method='post'>
	<h4>Description:</h4><br><textarea name='description' id='description' rows="5" cols="200"></textarea><br>
	<h4>Priority:<br><input type="radio" name="priority" value="0" checked>None given<br>
			<input type="radio" name="priority" value="1">1(High)<br>
			<input type="radio" name="priority" value="2">2<br>
			<input type="radio" name="priority" value="3">3(Low)<br> </h4>
