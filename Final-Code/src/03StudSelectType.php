...
<html lang="en">
  ...
  <body>
	...
	<div class="nextButton">
		<input type="submit" name="type" class="button large go" value="Individual" style="float: left">
		<input type="submit" name="type" class="button large go" value="Group" style="float: center">
	    </div>
		</div>
		</form>
<br>
<br>
		...
		<input type="submit" name="home" class="button large" value="Cancel" style="center">
		</form>
		</div>
  </body>
