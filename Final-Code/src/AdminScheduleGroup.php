...
<!-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% -->
	...
	<!-- Input field area for the majors -->
      <div class="field">
	  ...
	  <!-- Input field area for the repeat -->
        <div class="field">
		...
		<!-- Input field area for the stepper -->
        <div class="field">
        	<h3>Repeat for
		...
		<!-- Input field area for the limit to repeat -->
	<div class="field">
        	<h3>Student limit: 
