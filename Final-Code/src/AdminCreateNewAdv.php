...
<html lang="en">
  <head>
	...
	<!-- link to the relevant css file from the css folder to reduce file size -->
   ...
   <body>
    ...
    ?>	
		...
		<div class="field">
			...
			<input id="OfficeNum" size="20" maxLength="8" type="text" 
			pattern="[A-Za-z]{2,4}[0-9]{3}[a-z]{0,1}" title="ABCD123" placeholder="ITE203" name="OfficeNum" required>
		</div>
		...
		<div class="field">
			<br>
			<h5> Enter your appointment room number below,only if you have a specified room. </h5>
			<label for="ApptRoom">Appointment Room</label>
			<input id="ApptRoom" size="20" maxLength="8" type="text" 
			pattern="[A-Za-z]{2,4}[0-9]{3}[a-z]{0,1}" title="ABCD123" placeholder="ITE203" name="ApptRoom">
		</div>
