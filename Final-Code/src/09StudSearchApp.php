  ...
  <body>
    <div id="login">
      <div id="form">
	    ...
	    <div class="field">
		<!-- set an action to be sent to the search results of appt finding -->
		<form action="11StudSearchResult.php" method="post" name="SearchApp">
			
			<!-- Field to grab variable, to be sent off to process page-->
			<label for="date">Date</label>
			<!-- Add in input requirement directions, in addition to adding a box to input validate something -->
	      	<input id="date" type="date" name="date" placeholder="mm/dd/yyyy" required> Insert date in the form (mm/dd/yyyy)
			
			
			
			<!-- Field to grab variable, to be sent off to process page-->
			<!-- Only allow for there to be appts from 8:00am to 4:00 pm, all lasting half an hour-->
