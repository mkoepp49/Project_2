...
<head>
  <!-- 
  This file allows student to cancel appointment already made
  ...
  <body>
    <div id="login">
      <div id="form">
	    ...
	    <div class="field">
	    <?php
      // get student values from session
      ...
      // locate row in DB with student ID
      ...
      <!-- 
      uses StudProcessCancel.php to process value chosen
      -->
