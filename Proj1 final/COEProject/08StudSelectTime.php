...
// This file lets the student select group timing, or imports from 07
// which is for individual
// Also can cancel and go back to student home
...
$localAdvisor = $_SESSION["advisor"]; // advisor #
$localMaj = $_SESSION["major"]; // major value

// start debug from commonmethods, and get the advisor row from DB
  ...
  <body>
    <div id="login">
      <div id="form">
	    ...
	    <div class="field">
	    <!-- 
	    Time selection sent to 10... .php file 
	    -->
...
// Comparing timestamps, could not remember. 
        ...
        <!-- 
        after selection go to the next page or cancel to go to 02StudHome.php
        -->
