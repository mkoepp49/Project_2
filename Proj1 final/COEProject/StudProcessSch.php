...
// This file checks if appointment is open , and sets the appointment in database
...
// can not echo before header call --- > gives error
// 	if(debug) {
...
// }
	...
	// calls function to check if spot is available
	// nothing in brackets since it continues below
