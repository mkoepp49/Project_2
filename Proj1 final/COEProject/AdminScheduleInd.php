<?php
// Allows admin to create an individual appointment
// NOTE: could be merged with SchduleGroup by adding
// couple if statments, code is being repeated
session_start();
?>
...
<html lang="en">
  ...
  <body>
    <div id="login">
      <div id="form">
        <div class="top">
        <!-- 
        title and file that recives the input
        -->
		    <h1>Schedule Individual Appointments</h1>
        <!-- 
        NOTE CHANGED FROM Ind to Group, to reuse code! 
        -->
      ...
      <div class="field">
        ...
        <!-- 
        admin selects wether to repeat weekly
         -->
        <div class="field">
        ...
        <!-- 
        admin selects how many weeks to repeat this appointment
        -->
        <div class="field">
        	<h3>Repeat for
  ...
  <!-- 
  goes back to admin home, without creating appointment
  -->
