<?php
session_start();
// This file allows student to edit their info in the DB
...
// Code below commented out, since it never updates once student has logged out
// after commenting out, 06 will show current student data, 
// rather than first student all the time
...
//   // loop until row with student ID is found
//   // set values from found row in DB
...
<html lang="en">
  <head>
    <!-- 
  Removed double css code, and reused css in folder
  -->
  ...
  <body>
    <div id="login">
      ...
      <!-- 
      Data will be passed to StudProcessEdit.php
      -->
        ...
        -->
			...
			<div class="field">
          <!--
          updated values for each field
          note, also added ENGR! 
          -->
