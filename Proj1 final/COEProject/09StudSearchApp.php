...
<html lang="en">
  <head>
    <!-- 
  This file allows student to search for appointments based on date/time
  also removed double css code, and reused css in folder
  -->
  ...
  <body>
    <div id="login">
      <div id="form">
	    ...
	    <div class="field">
    <!--
    chosen date and time passed into 11StudSearchResult.php
    -->
      ...
      <!-- 
      advisor drop to choose advisor available on the date/time chosen
      -->
        ...
        // get the advisors schedule from DB using while loop
      ...
      <!-- 
      passes the data into 11StudSearchResult.php
      -->
