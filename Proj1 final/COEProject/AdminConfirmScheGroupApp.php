<?php
// This file shows the appointment created, or could not create
session_start();
$debug = false;
    ...
    <div id="login">
      <div id="form">
        <div class="top">
          ...
          <?php
            // get chosen values from previous page
            $date = $_POST["Date"];
            $times = $_POST["time"];
            $majors = $_POST["major"];
          ...
          $d5 = '+5 day ' . $date;
          $d6 = '+6 day ' . $date;
          // creates array wich converts d + date to strtotime format
          ...
          //major stuff
          // Prints out every major chosen by admin for the appointment
          $majorDB = "";
          $majorPrint = "All";
          if(!empty($majors)){
            $majorPrint = "";
          ...
          //get advisor id
          // calls session to get back what was entered to log in, 
          // and confirms its admin by checking DB
          $User = $_SESSION["UserN"];
          $Pass = $_SESSION["PassW"];
          ...
          // to avoid redundant code, simple if statement to check if group or not

          // if individual appointment
          $outnow = $_SESSION["advisor"];
