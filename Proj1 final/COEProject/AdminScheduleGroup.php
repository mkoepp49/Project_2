<?php
// This file schedules the group appointment on admin side
session_start();
?>
...
<b><font color="red" size="3">Please note only <u>one</u> staff member needs to schedule the GROUP session since it involves all of you. Please identify which advisor will enter this type meeting before continuing.</font></b>
        ...
        <!-- 
        values chosen passed to the .php file below
        -->
...
<!-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% -->
      ...
      <div class="field">
        ...
        <!-- 
        Admin selects on which day to repeat weekly
        -->
        <div class="field">
  ...
  <!-- 
  max students in group appointment
  -->
	<div class="field">
        	<h3>Student limit: 
...
<!--         if($_SESSION["advisor"] == "Group"){
  echo "<h3 style='color:red'>working</h3>";
          }
  ...
  -->
    ...
    <!-- 
    cancel takes back to admin home
    -->
