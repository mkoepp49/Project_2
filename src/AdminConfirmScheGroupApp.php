    ...
    <div id="login">
      <div id="form">
        <div class="top">
          ...
          <?php
		    /* List of variables sent from the AdminScheduleGroup.php file,
			/ to be used throughout the file to access DB necessary aspects */
            $date = $_POST["Date"];
            $times = $_POST["time"];
            $majors = $_POST["major"];
          ...
          // Initialize the first week into array
          $dates = array();
          ...
          // Repeat the dates with first week
          ...
          // Correspond date and time into sequence of YYYY-MM-DD hh:mm:ss
          $datetimes = array();
          ...
          // If the appointment doesn't exist yet,
          // Select the User from the DB query and 
          // Print Appt to the User
	  ...
	  <!-- Cannot create appointment, Go back to AdminUI.php -->
      <div class="bottom">
